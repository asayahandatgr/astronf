...
const Astrofest = () => {
  ...
  return (
    <div className="bg-yellow-400 min-h-[540px] pb-8 relative overflow-hidden border-b-8 border-black">
      {/* Diagonal purple accent */}
      <div className="absolute left-0 top-0 w-full h-20 -skew-y-6 z-0"></div>
      {/* Judul pakai gambar besar */}
      <div className="relative z-10 pt-8 pl-8 flex items-center gap-4">
        <img
          src="/assets/astrofest/stat-titles.png"
          alt="Star Titles"
          className="w-[420px] md:w-[560px] drop-shadow-lg"
        />
      </div>
      {/* Konten utama */}
